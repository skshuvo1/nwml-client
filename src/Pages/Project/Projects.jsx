...
<div className="card card-compact bg-base-100 shadow-xl">
  <figure><img className='hover:scale-150 duration-500 ' src={warping} alt="warping" /></figure>
...
<div className="card card-compact bg-base-100 shadow-xl">
  <figure><img className='hover:scale-150 duration-500 ' src={sizing} alt="sizing" /></figure>
  <div className="card-body">
...
<div className="card card-compact bg-base-100 shadow-xl">
  <figure><img className='hover:scale-150 duration-500 ' src={folding} alt="Folding" /></figure>
  <div className="card-body">
...
<div className="card card-compact bg-base-100 shadow-xl">
  <figure><img className='hover:scale-150 duration-500 ' src={toyota} alt="toyota" /></figure>
  <div className="card-body">
