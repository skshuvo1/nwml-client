...
<div className="carousel w-full min-h-screen" >
  ...
  <div className=" max-w-md mt-96 ms-48 text-white ">
      ...
      <button className="btn btn-outline btn-secondary">Our Portfolio <FaArrowRight></FaArrowRight></button>
    </div>
  ...
  <div className="max-w-md mt-96 ms-48 text-white">
      <h1 className="mb-5 text-5xl font-bold">Hello there</h1>
      <p className="mb-5">Provident cupiditate voluptatem et in. Quaerat fugiat ut assumenda excepturi exercitationem quasi. In deleniti eaque aut repudiandae et a id nisi.</p>
      <button className="btn btn-outline btn-secondary mb-8">Our Portfolio <FaArrowRight></FaArrowRight></button>
    </div>
    <div className="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
      <a href="#slide3" className="btn btn-circle">❮</a> 
      <a href="#slide1" className="btn btn-circle">❯</a> 
