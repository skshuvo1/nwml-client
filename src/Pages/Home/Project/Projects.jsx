...
<div className="card card-compact bg-base-100 shadow-xl">
  ...
  <div className="card-body">
    ...
    <p className='text-slate-500'>Warping is the preparation of yarn to weave fabric. It is the transfer of many yarns from the creel of single packages to a beam. The yarns will form a parallel sheet of yarn wound onto the beam.<Link className='text-blue-700 underline'>See More</Link></p>
  </div>
</div>
...
<div className="card card-compact bg-base-100 shadow-xl">
  ...
  <div className="card-body">
    ...
    <p className='text-slate-500'>Sizing is a complementary operation carried out on warps formed by spun yarns with insufficient tenacity or by continuous filament yarns with zero twists. In general, when sizing is necessary.<Link className='text-blue-700 underline'>See More</Link></p>
  </div>
</div>
...
<div className="card card-compact bg-base-100 shadow-xl">
  ...
  <div className="card-body">
    ...
    <p className='text-slate-500'>This is a textile machinery works as fabric folders used in textile factory or textile mills. This machine is specially designed primarily for the folding of fabric and textile design.<Link className='text-blue-700 underline'>See More</Link></p>
  </div>
</div>
<div className="card card-compact bg-base-100 shadow-xl">
