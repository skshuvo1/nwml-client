...
import PicanolMC from './PicanolMC';
...
const Picanol = () => {
    return (
        <div>
            ...
            <h2 className=' font-bold text-center mb-8 pt-8 text-2xl'>Pi<span className='text-red-500'>can</span>ol </h2>
            <div className='flex flex-col lg:flex-row m-8 gap-8 mt-8 justify-center items-center'>
                ...
                <div className='w-full lg:w-1/3 lg:-mt-24'>
                    <h2 className='text-center text-xl my-3 font-bold text-red-500 '>Picanol</h2>
