...
import VamatexBrief from './VamatexBrief';
...
const VamatexMC = () => {
  ...
  <div className="card w-84 h-84 rounded-xl bg-base-100 shadow-xl hover:scale-150 hover:z-10 duration-300">
<figure><img className=' rounded w-full ' src="https://konicainternational.b-cdn.net/wp-content/uploads/2019/10/UNADJUSTEDNONRAW_thumb_75c1.jpg" alt="Shoes" /></figure>
  ...
  <div className="card w-84 rounded-xl bg-base-100 shadow-xl hover:scale-150 hover:z-10 duration-300">
...
<VamatexBrief></VamatexBrief>
</div>
    );
};

export default VamatexMC;